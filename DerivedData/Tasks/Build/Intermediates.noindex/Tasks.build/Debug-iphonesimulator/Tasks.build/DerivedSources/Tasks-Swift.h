...
#ifndef TASKS_SWIFT_H
#define TASKS_SWIFT_H
...
SWIFT_CLASS("_TtC5Tasks11AppDelegate")
...
SWIFT_CLASS("_TtC5Tasks19EntryViewController")
@interface EntryViewController : UIViewController <UITextFieldDelegate>
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified field;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC5Tasks13SceneDelegate")
...
SWIFT_CLASS("_TtC5Tasks18TaskViewController")
...
SWIFT_CLASS("_TtC5Tasks14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(Tasks)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end

@class UITableViewCell;

@interface ViewController (SWIFT_EXTENSION(Tasks)) <UITableViewDataSource>
